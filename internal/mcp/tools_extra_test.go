...
func TestExtraToolsRegistered(t *testing.T) {
	...
	want := []string{
		...
		"set_autopilot", "autopilot_status", "list_autopilot_runs", "register_autopilot_run", "control_autopilot_run", "rename_autopilot_run", "retarget_autopilot_run", "land", "autopilot_complete",
