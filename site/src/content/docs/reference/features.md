...
`wd`), **MCP** (63 structured tools for an orchestrating Claude), the **/warden
...
| Orchestrator REPL (local LLM) | `orch` | **CLI-only** (interactive REPL) | — | — | — | [orchestrator-repl](https://srjn45.github.io/warden/multi-agent/orchestrator-repl/) |
