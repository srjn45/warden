...
| Tier picker + live candidate table in the new-agent form (`ctrl+t`; `auto` / `tier-1`/`2`/`3`; headroom bars; resolver picks backend+model) | new-agent form | [agent-roles](https://srjn45.github.io/warden/guides/agent-roles/) |
